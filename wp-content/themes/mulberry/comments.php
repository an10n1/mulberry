...
<div id="comments" class="comments-area">
	<?php if (have_comments()) : ?>
		<h3 class="comments-title">
			<span>
				...
				<?php _e('1 Комментарий', 'portfolio'); ?>
				<?php elseif(get_comments_number() == 2) : ?>
				<?php _e('2 Комментарий', 'portfolio'); ?>
				<?php elseif(get_comments_number() > 2) : ?>
				<?php printf(__('%1$s Комментарий', 'portfolio'), number_format_i18n(get_comments_number())); ?>
				<?php endif; ?>
			</span>
		</h3>
		...
		<nav>
			...
			<div class="nav-prev"><?php previous_comments_link(__('&larr; Старые', 'portfolio')); ?></div>
			<div class="nav-next"><?php next_comments_link(__('Новые &rarr;', 'portfolio')); ?></div>
	...
	<?php 
		comment_form(
			array(
				'title_reply' => '<span>' . __('Отправить комментарий', 'portfolio') . '</span>'
			)
		); 
	?>
</div><!-- #comments -->
