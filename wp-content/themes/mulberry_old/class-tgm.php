...
add_action( 'tgmpa_register', 'unar_register_required_plugins' );
 ...
 */
function unar_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Unar Extra', 'unar' ), // The plugin name
			'slug'     				=> 'unar-extra', // The plugin slug (typically the folder name)
			//'source'   				=> get_stylesheet_directory() . '/plugins/unar-extra.zip', // The plugin source
		...
		array(
			'name'     				=> esc_html__( 'Elementor', 'unar' ), // The plugin name
